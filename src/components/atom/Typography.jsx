...
export const Typography = (
    ...
    if (variant === "gradient") {
      const GradientComponent = component || "span";

      return (
        <GradientComponent
          className={clsx(className, "font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary")}>
          {children}
        </GradientComponent>
      );
    }
